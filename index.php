...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <div class="logo">
        <h1><a href="index.php">Poltek Gajah Tunggal</a></h1>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-5 col-md-12" data-aos="fade-up" data-aos-delay="300">
            <form action="pendaftaran.php" method="post" role="form">
          ...
          <select name="jurusan">
              ...
              <option value="Manajeman">Manajemen</option>
              ...
              <div class="text-center"><button type="submit" name="daftar">Daftar</button></div> -->
            </form>
          </div>
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        while($siswa = mysqli_fetch_array($query)){
          ...
          echo "<td>";
            echo "<a href='form-edit.php?id=".$siswa['nim']."'>Edit</a>";
              "</td>";
          echo "<td>";
            echo "<a href='hapus.php?id=".$siswa['nim']."'>Delete</a>";
              "</td>";
            ...
            <div class="swiper-slide">
              <div class="testimonial-wrap">
                <div class="testimonial-item">
                  ...
                  <?php
                  $sql= "SELECT * FROM mahasiswa WHERE nim='12345'";
                  $query = mysqli_query($koneksi, $sql);
